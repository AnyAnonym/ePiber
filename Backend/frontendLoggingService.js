...
const EVENT_LEVELS = new Map([
  ...
  ["competitions_load_failed", "error"],
    ...
    ["competition_history_comments_load_failed", "error"],
    ["competition_history_comment_write_failed", "error"],
    ["competition_history_reactions_load_failed", "error"],
    ["competition_history_reaction_write_failed", "error"],
    ["competition_history_comment_reactions_load_failed", "error"],
    ["competition_history_comment_reaction_write_failed", "error"],
  ...
  ["match_action_picker_load_failed", "error"],
  ["favorite_labels_load_failed", "error"],
  ["favorites_load_failed", "error"],
  ["favorites_save_failed", "error"],
  ["hall_time_load_failed", "error"],
  ["hall_time_write_failed", "error"],
  ["hall_time_admin_load_failed", "error"],
  ["hall_time_admin_write_failed", "error"],
