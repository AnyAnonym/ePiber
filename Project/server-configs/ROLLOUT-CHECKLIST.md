...
- [ ] Zehn gemeinsame Dashboards sind vorhanden; die Deploymentauswahl `live|paj` trennt Anwendungswerte eindeutig, Hostressourcen werden nicht doppelt gezaehlt. Die Fachdashboards `ePiber Meldungen` und `ePiber Hallenreservierung` sind vorhanden.
